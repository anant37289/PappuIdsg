...
def args_parser():
    ...
    parser.add_argument(
        "--epochs", type=int, default=50, help="number of rounds of training"
    )
    ...
    # model arguments
    parser.add_argument(
        "--num_channels", type=int, default=1, help="number of channels of imgs: 1 or 3"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=str,
        default="True",
        help="Use max pooling or strided convolutions",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default="fmnist",
        help="name of dataset: mnist, fmnist, cifar, svhn",
    )
