...
if datas == "SVHN":
    ...
    train_dataset = datasets.CIFAR10(
        root="./data/cifar/", train=True, transform=apply_transform_cifar
    )
    test_dataset = datasets.CIFAR10(
        root="./data/cifar/", train=False, transform=apply_transform_cifar
    )
elif datas == "MNIST":
    train_dataset = datasets.MNIST(
        root="./data/", train=True, transform=apply_transform_mnist
    )
    test_dataset = datasets.MNIST(
        root="./data/", train=False, transform=apply_transform_mnist
    )
elif datas == "FMNIST":
